...
public record InvoiceDto(int Id, DateTime Date, Domain.Enums.InvoiceStatus Status, IEnumerable<InvoiceItemDto> Items, decimal SubTotal, decimal Vat, decimal Total, decimal? Paid);
